...
func main() {
	...
	minDurationFlag := flag.Int("min", 0, "Minimum duration in seconds to include in the output (e.g., 1 will filter out activities less than 1 second)")
	appOnlyFlag := flag.Bool("apps", false, "Only display per-application report, skip window details")
